...
const AddArtistModal = ({ isOpen, onClose, onSuccess, areas }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (response.ok) {
                addToast({
                    description: language === 'heb' ? 'האמן נוסף בהצלחה' : 'Artist added successfully',
                    color: "success",
                    timeout: 3000
                });
                ...
                addToast({
                    description: error.message || (language === 'heb' ? 'שגיאה בהוספת האמן' : 'Error adding artist'),
                    color: "danger",
                    timeout: 3000
                });
            }
            ...
            addToast({
                description: language === 'heb' ? 'שגיאה בהוספת האמן' : 'Error adding artist',
                color: "danger",
                timeout: 3000
            });
        } finally {
    ...
    const translations = {
        addArtist: { heb: 'הוסף אמן חדש', eng: 'Add New Artist' },
